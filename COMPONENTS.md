...
- **Location:** app.js · `makeClipDecoder(d,ex)` (~L8069). Per-clip glue `_vinstUrl`/`_useCD`/`vinstEnsure` (~L8324-8397), `vinstSeek`/`seekCDExport`/`vinstSeekVideo` (~L8465-8496), `driveCD` (~L8512). Demuxador: `demuxMP4` (~L7979).
