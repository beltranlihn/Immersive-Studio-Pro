...
Source: `app.js` (~15859 lines). Line numbers verified against the working tree on 2026-08-09 (R344).
...
- **Location:** app.js · `makeClipDecoder(d,ex)` (~L8069). Per-clip glue `_vinstUrl`/`_useCD`/`vinstEnsure` (~L8281-8354), `vinstSeek`/`seekCDExport`/`vinstSeekVideo` (~L8422-8453), `driveCD` (~L8469). Demuxador: `demuxMP4` (~L7979).
