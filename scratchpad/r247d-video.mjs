...
await toma('lleno',  {bands:5,weaveMode:'weave',bandW:100,fit:'across',density:1,speed:0.10,speedV:0.10,motion:'alternate',interlace:true},false);
await toma('huecos', {bands:5,weaveMode:'weave',bandW:60, fit:'across',density:1,speed:0.10,speedV:0.10,motion:'alternate',interlace:true},true);
await toma('lineas', {bands:3,weaveMode:'h',    bandW:35, fit:'along', density:1,speed:0.12,motion:'same',interlace:false},false);
